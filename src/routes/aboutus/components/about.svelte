<section id="aboutus" class="h-full  md:p-8 bg-gray-50/10 rounded-b-3xl shadow-lg ">
	<div
		class="lg:max-w-[1600px] pt-[35px] flex ml-auto mr-auto flex-col-reverse lg:flex-row text-justify items-center justify-center"
	>
		<div
			data-aos="fade-up"
		...
		>
			...
			<p class=" text-sm md:text-base">
				...
				we're a close-knit family sharing a common vision and strong work ethic.
			</p>
		</div>
		<div data-aos="fade-in" class="basis-1/2 p-4">
			<img src="./aboutsus.svg" alt="" class=" sticky max-lg:h-[300px]" />
		</div>
	</div>
</section>
