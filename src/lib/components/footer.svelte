			...
			<div class="footer-left-details flex gap-4 flex-col">
				...
				<div class="flex gap-2">
					<svg
						...
						/></svg
					>
					<a href="mailto:praghuwanshi@softorphic.com" class="font-medium max-lg:text-sm text-gray-500">praghuwanshi@softorphic.com</a>
				</div>
				<div class="flex gap-2">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						...
						/></svg
					>
					<a href="tel:+917000268413" class="font-medium max-lg:text-sm text-gray-500">+91 7000268413</a>
				</div>
			</div>
		</div>
