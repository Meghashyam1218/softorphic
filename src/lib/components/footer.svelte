<section class="footer bg-gray-100 p-4 border-t-4 border-rose-600">
	<div class="w-[90vw] xl:w-[80vw] max-w-[1200px] flex max-lg:flex-col max-lg:gap-8 justify-between mx-auto p-4">
			...
			<div class="footer-left-details flex gap-4 flex-col">
				<div class="flex gap-2">
					<svg
						...
						/></svg
					>
					<p class="font-medium max-lg:text-sm text-gray-500">998 Devonshire Ave.Camp Hill, PA 17011</p>
				</div>
				<div class="flex gap-2">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						...
						/></svg
					>
					<p class="font-medium max-lg:text-sm text-gray-500">softorphic@mail.com</p>
				</div>
				<div class="flex gap-2">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						...
						/></svg
					>
					<p class="font-medium max-lg:text-sm text-gray-500">+91 998774411</p>
				</div>
			</div>
		</div>
		...
		<div class="footer-right flex flex-col max-lg:items-center gap-1">
